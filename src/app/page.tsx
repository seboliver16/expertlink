  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between bg-gray-50 p-8">
      ...
      <section className="flex flex-col items-center text-center py-20">
        ...
        <Link href="/search">
          <span className="bg-gradient-to-r from-blue-500 to-blue-700 text-white px-10 py-4 rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-transform">
            Get Started
          </span>
        </Link>
      </section>
